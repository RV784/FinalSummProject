window.onload = function() {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyB6cy_u5zYQTrNsxOrLdYqms2s8y9lvGio",
    authDomain: "udemy-chatroom-7391d.firebaseapp.com",
    projectId: "udemy-chatroom-7391d",
    storageBucket: "udemy-chatroom-7391d.appspot.com",
    messagingSenderId: "104150995501",
    appId: "1:104150995501:web:27578c38c9e016a9029ea4",
    measurementId: "G-J2C1MNEV5P"
  };
  // Initialize Firebase
  ...
  class UDEMY_CHAT{
    ...
    create_title(){
      ...
      title.textContent = 'ChatRoom-udemy'
    ...
    create_join_form(){
      ...
      join_input.placeholder = 'Enter your name and click Join!'
